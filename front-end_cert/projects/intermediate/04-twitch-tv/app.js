$(document).ready(function(){
  ...
  var users_data =[],temp = [];
  var selected_users;
   // The twitch API now requres a client-id. I don't want to share my key on codepen.
   // I saved a snapshot of the streamers data, and built a fake api on HyperDev
   // which serves that data, simulating the original API.
  var url = "https://foam-lady.hyperdev.space/twitch-api/"; //"https://api.twitch.tv/kraken/"
  var st = "streams/";
  var us = "users/";
  var cb = '?callback=?';
  ...
  function displayData(){
    // warning ! It's not real data. I'm using a fake API.
    $('.container').prepend('<p class="info">Warning!: This is a snapshot\
     of the Twitch.tv API response taken at 10-09-2016_23:00-CEST</p>');
